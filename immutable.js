...
*/
const person = { name: 'George', hometown: 'Georga', age: 56 }
const newPerson = Object.assign({...person}, {name: 'AJ Genung', age: 14})
...
const superHeroes = ['Superman', 'Batman', 'Spiderman', 'Arrow', 'Supergirl'];
const superVillains = ['Lex Luthor', 'Bane', 'Venom', 'Tom Merrlin', 'Reign'];
...
const studentScores = {
  name: 'Jessica',
  age: 17,
  scores: [89, 34, 35, 100, 100, 97, 84, 62, 22, 2, 18]
};
